...
/**
 * Created by diseno on 9/15/15. for BeePoll
 */
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements OnClickListener{
        ...
        public ViewHolder(View itemView,int ViewType, Context c) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                aSwitch = (Switch) itemView.findViewById(R.id.swConf);
        ...
        public void onClick(View view) {
            ...
            switch(getPosition()){
                case 0: Log.i(TAG, "Header Material Drawer");
                    break;
                case 1: Log.i(TAG, "Abre opc 1");
                break;
                case 2: Log.i(TAG, "Abre opc 2");
                    break;
                case 3: Log.i(TAG, "Abre opc 3");
                    break;
                case 4: Log.i(TAG, "Abre opc 4");
                    break;
                case 5: Log.i(TAG, "Abre opc 5");
                    break;
                default: Log.w(TAG, "Ha ocurrido un error");
                    break;
            }
        }
    }
    ...
    MyAdapter(String Titles[],int Icons[],String Name,String Email, int Profile, int[] swOpc, Context passedContext){ // MyAdapter Constructor with titles and icons parameter
